...
import com.sp.sysframework.reference.AppConfig;
  ...
  public class BLTransDataYB2206 {

  String[] arrCustomerCode = new String[2];
 protected final Log logger = LogFactory.getLog(getClass());
  public BLTransDataYB2206() {
  }
  ...
  String comCode ="";
  String jobGroup ="";
  String jobDes="BLTransDataYB2206转数失败日志记录";
  String businessKey ="";
  String executeDate   ="";
  String successFlag ="";
  String errorMessage ="";
  ...
  double bankDisRate_PrpTexpense=0.0;
   ...
   /**
     ...
     * @throws Exception
     */
    public BLProposal generateObjectOfProposal(DBManager dbManager, BankInterFace_DetailDto bankInterFace_DetailDto,BankInterface_ExtSchema bankInterface_ExtSchema ,String iVisaCode) 
        throws Exception 
    {
      ...
      blPrpTaddress = generateObjectOfTaddress(bankInterFace_DetailDto,bankInterface_ExtSchema);
    ...
    /**
     * @desc 由接口表数据  生成BLPrpTmainLoan对象
     * @author shenjun
     * @param bankInterFace_DetailDto
     * @return bLPrpTmainLoan
     * @throws Exception 
     */
    public BLPrpTmainLoan generateObjectOfTmainLoan(
	    ...
	    prpTmainLoanSchema.setRiskCode("2206");
	    ...
	    if(sumAmount<loanAmount){
	    	  errorMessage="BLTransDataYB2206.generateObjectOfTmainLoan 借款金额不能大于总XX,此单转数失败！";
	        throw new UserException(-98, -1167, "BLTransDataYB2206.generateObjectOfTmainLoan",
	            "BLTransDataYB2206.generateObjectOfTmainLoan 借款金额不能大于总XX,此单转数失败！" ); 
	    }
	    prpTmainLoanSchema.setLoanAmount(strLoanAmount); 
	    ...
	    if(loanYear==0) loanYear++;
	    prpTmainLoanSchema.setLoanYear(loanYear+"");
	    blPrpTmainLoan.setArr(prpTmainLoanSchema);
	    return blPrpTmainLoan;
    }
    /**
     * @desc 由接口表数据 生成BLPrpTitemHouse对象
     * @param bankInterFace_DetailDto
     * @return blPrpTitemHouse
     * @throws Exception 
     */
    public BLPrpTitemHouse generateObjectOfTitemHouse(
		BankInterFace_DetailDto bankInterFace_DetailDto,BankInterface_ExtSchema bankInterface_ExtSchema) throws Exception {
	    ...
	    prpTitemHouseSchema.setRiskCode("2206");
    ...
    public BLPrpTmainBank generateObjectOfTmainBank(BankInterFace_DetailDto bankInterFace_DetailDto) throws Exception {
      ...
      prpTmainBankSchema.setRiskCode("2206");
      prpTmainBankSchema.setClassCode("22");
        ...
        String iVisaCode) throws Exception 
    {
      ...
      if(prpdBankCompannyDtoList.size() == 0){
    	  errorMessage="BLTransDataYB2206.generateObjectOfTmain"+"prpdbankcompanny表"+ "prpdbankcompanny表"+strBankCode+"取值失败,请管理员进行配置！";
        throw new UserException(-98, -1167, "BLTransDataYB2206.generateObjectOfTmain",
      ...
      if(!checkChannelYB.checkChannel(bankInterFace_DetailDto.getComCode(),strAgentCode)){
    	  errorMessage="BLTransDataYB2206.generateObjectOfTmain"+  "业务来源与渠道校验失败，请检查相关配置！" ;
    	  throw new UserException(-98, -1167, "BLTransDataYB2206.generateObjectOfTmain",
    	            "业务来源与渠道校验失败，请检查相关配置！" ); 
      }
	          ...
	          if(prpDagreeDetailDto==null){
	          	errorMessage="BLTransDataYB2206.generateObjectOfTmain"+ "手续费比例取值失败,请管理员进行配置！" ;
	            throw new UserException(-98, -1167, "BLTransDataYB2206.generateObjectOfTmain",
	            "手续费比例取值失败,请管理员进行配置！" ); 
	          }    
      ...
      if("N01".equals(strChannelType) && "5".equals(dbPrpDcompany.getComLevel())){
          ...
          if(prpDriskConfigDto!=null && prpDriskConfigDto.getConfigValue().indexOf("S13")>-1){
              prpTmainSchema.setChannelTypeSub("S13");
	            ...
	            throw new UserException(-98, -1167, "BLTransDataYB2206.generateObjectOfTmain","渠道取值失败,XX归属渠道为N01,子渠道不存在S13!" ); 
	        }
      }else{
	        if(!"N03".equals(strChannelType)){
              throw new UserException(-98, -1167, "BLTransDataYB2206.generateObjectOfTmain","渠道取值失败,渠道只能N01、N03!" ); 
	        }
      }
		...
		if("1".equals(bankInterFace_DetailDto.getIseiesflag())&&dbPolicyFee!=0.0){
			...
			if("1".equals(AppConfig.get("sysconst.SECTION_ACCOUNT_2206_OPEN"))){
     ...
     * @throws Exception
     */
    public BLPrpTaddress generateObjectOfTaddress(BankInterFace_DetailDto bankInterFace_DetailDto,BankInterface_ExtSchema bankInterface_ExtSchema) throws Exception 
    {
      ...
      prpTaddressSchema.setAddressCode(bankInterface_ExtSchema.getHousePostCode());
      prpTaddressSchema.setAddressName(bankInterface_ExtSchema.getHouseAddress());
    ...
    public BLPrpTitemKind generateObjectOfTitemKind(BankInterFace_DetailDto bankInterFace_DetailDto) throws Exception {
      ...
      prpTitemKindSchema.setRiskCode("2206");
      ...
      prpTitemKindSchema.setRate(PubTools.round((bankInterFace_DetailDto.getSumPremium()/bankInterFace_DetailDto.getSumamount()) * 1000, 4)+"");
