...
public class BLPrpdMotorcadeExpense{
    ...
    /**
     *增加一条PrpdMotorcadeExpenseSchema记录
    ...
    /**
     *得到一条PrpdMotorcadeExpenseSchema记录
     *@param index 下标
     *@return 一个PrpdMotorcadeExpenseSchema对象
     *@throws Exception
     */
    ...
    /**
     *删除一条PrpdMotorcadeExpenseSchema记录
     *@param index 下标
     *@throws Exception
     */
