...
public class BLTransDataYB0301 {
  
  /*
     * 本类完成的功能：
     * 将BankInterFace_Detail表中当前所有的数据转换为0301XX数据，并送相关数据到收付的接口表中
  ...
  public BLTransDataYB0301() {
  }
  protected final static Log logger = LogFactory.getLog(BLTransDataYB0301.class);
  ...
  String comCode ="";
  String jobGroup ="";
  String jobDes="BLTransDataYB0301转数失败日志记录";
  String businessKey ="";
  String executeDate ="";
  String successFlag ="";
  String errorMessage ="";
  ...
  public String transData(DbPool dbPool,BankInterFace_DetailDto bankInterFace_DetailDto,String isEiesFlag,String vscode)throws Exception{
   ...
   createCode   ="ZJYW_0301_admin";
    ...
    try{
      ...
      blTaskFacade.start(dbManager,"11","T",strProposalNo,"0301",
   ...
   /**
    ...
    public BLPrpTexpense generateObjectOfTexpense(DbPool dbPool,BankInterFace_DetailDto bankInterFace_DetailDto)throws Exception 
    {
      ...
      if(prpdBankCompannyDtoList.size() == 0){
      	 errorMessage="BLTransDataYB0301.generateObjectOfTexpense"+"prpdbankcompanny表"+strBankCode+"取值失败,请管理员进行配置！" ;
        throw new UserException(-98, -1167, "BLTransDataYB0301.generateObjectOfTexpense",
    ...
    public BLPrpTmain generateObjectOfTmain(String[] arrCustomerCode, BankInterFace_DetailDto bankInterFace_DetailDto, String visacode, String arrProposalNo,String IsEiesFlag) throws Exception {
      ...
      if(prpdBankCompannyDtoList.size() == 0)
      { errorMessage="BLTransDataYB0301.generateObjectOfCommission"+"prpdbankcompanny表"+strBankAgentCode+"取值失败,请管理员进行配置！";
        throw new UserException(-98, -1167, "BLTransDataYB0301.generateObjectOfCommission",
      ...
      if(!checkChannelYB.checkChannel(bankInterFace_DetailDto.getComCode(),strAgentCode)){
    	  ...
    	  errorMessage="BLTransDataYB0301.generateObjectOfTmain"+"业务来源与渠道校验失败，请检查相关配置！";
      ...
      {errorMessage="BLTransDataYB0301.generateObjectOfTmain"+"手续费比例取值失败,请管理员进行配置！";
        throw new UserException(-98, -1167, "BLTransDataYB0301.generateObjectOfTmain",
        "手续费比例取值失败,请管理员进行配置！" ); 
      }      
      ...
      prpTmainSchema.setRiskCode("0301");
      ...
      if("N01".equals(strChannelType) && "5".equals(dbPrpDcompany.getComLevel())){
          ...
          if(prpDriskConfigDto!=null && prpDriskConfigDto.getConfigValue().indexOf("S13")>-1){
              prpTmainSchema.setChannelTypeSub("S13");
	            ...
	            throw new UserException(-98, -1167, "BLTransDataYB0301.generateObjectOfTmain","渠道取值失败,XX归属渠道为N01,子渠道不存在S13!" ); 
	        }
      }else{
	        if(!"N03".equals(strChannelType)){
              throw new UserException(-98, -1167, "BLTransDataYB0301.generateObjectOfTmain","渠道取值失败,渠道只能N01、N03!" ); 
	        }
      }
		...
		if("1".equals(bankInterFace_DetailDto.getIseiesflag())&&dbPolicyFee!=0.0){
			...
			if("1".equals(AppConfig.get("sysconst.SECTION_ACCOUNT_0301_OPEN"))){
    ...
    public BLPrpTinsured generateObjectOfTinsured(String[] arrCustomerCode, BankInterFace_DetailDto bankInterFace_DetailDto, String arrProposalNo,String IsEiesFlag) throws Exception {
      ...
      prpTinsuredSchema1.setRiskCode("0301");
      ...
      prpTinsuredSchema2.setRiskCode("0301");
    ...
    public BLPrpTmainBank generateObjectOfTmainBank(BankInterFace_DetailDto bankInterFace_DetailDto, String arrProposalNo) throws Exception {
      ...
      prpTmainBankSchema.setRiskCode("0301");
    ...
    public BLPrpTitemKind generateObjectOfTitemKind(BankInterFace_DetailDto bankInterFace_DetailDto, String arrProposalNo,String IsEiesFlag) throws Exception {
      ...
      prpTitemKindSchema.setRiskCode("0301");
    ...
    public BLPrpTbatch generateObjectOfTbatch(BankInterFace_DetailDto bankInterFace_DetailDto,String arrProposalNo,String IsEiesFlag,String visacode) throws Exception {
      ...
      prpTbatchSchema.setRiskCode("0301");
