...
import com.sp.sysframework.reference.AppConfig;
  ...
  public class BLTransDataYB2700 {

  String[] arrCustomerCode = new String[2];
 protected final Log logger = LogFactory.getLog(getClass());
  public BLTransDataYB2700() {
  }
  ...
  String comCode ="";
  String jobGroup ="";
  String jobDes="BLTransDataYB2700转数失败日志记录";
  String businessKey ="";
  String executeDate   ="";
  String successFlag ="";
  String errorMessage ="";
        ...
        String isEiesFlag,String vscode)throws Exception
  {
   ...
   createCode   ="ZJYW_2700_admin";
    ...
    try{     
      ...
      blTaskFacade.start(dbManager,"11","T",strProposalNo,"2700",
   ...
   /**
    ...
    public BLPrpTmainBank generateObjectOfTmainBank(BankInterFace_DetailDto bankInterFace_DetailDto) throws Exception {
      ...
      prpTmainBankSchema.setRiskCode("2700");
      prpTmainBankSchema.setClassCode("27");
        ...
        String iVisaCode) throws Exception 
    {
      ...
      if(prpdBankCompannyDtoList.size() == 0){
    	  errorMessage="BLTransDataYB2700.generateObjectOfTmain"+"prpdbankcompanny表"+ "prpdbankcompanny表"+strBankCode+"取值失败,请管理员进行配置！";
      ...
      if(!checkChannelYB.checkChannel(bankInterFace_DetailDto.getComCode(),strAgentCode)){
    	  errorMessage="BLTransDataYB2700.generateObjectOfTmain"+  "业务来源与渠道校验失败，请检查相关配置！" ;
    	  throw new UserException(-98, -1167, "BLTransDataYB2700.generateObjectOfTmain",
    	            "业务来源与渠道校验失败，请检查相关配置！" ); 
      }
      ...
      if("N01".equals(strChannelType) && "5".equals(dbPrpDcompany.getComLevel())){
          ...
          if(prpDriskConfigDto!=null && prpDriskConfigDto.getConfigValue().indexOf("S13")>-1){
	          ...
	          throw new UserException(-98, -1167, "BLTransDataYB2700.generateObjectOfTmain","渠道取值失败,XX归属渠道为N01,子渠道不存在S13!" ); 
          }
       }else{
           if(!"N03".equals(strChannelType)){
	           throw new UserException(-98, -1167, "BLTransDataYB2700.generateObjectOfTmain","渠道取值失败,渠道只能N01、N03!" ); 
           }
       }
		...
		if("1".equals(bankInterFace_DetailDto.getIseiesflag())&&dbPolicyFee!=0.0){
			...
			if("1".equals(AppConfig.get("sysconst.SECTION_ACCOUNT_2700_OPEN"))){
				if("103".equals(bankInterFace_DetailDto.getBfbankCode())){
     ...
     * @throws Exception
     */
    public BLPrpTitemKind generateObjectOfTitemKind(BankInterFace_DetailDto bankInterFace_DetailDto) 
        throws Exception 
    {
  ...
  public BLPrpTexpense generateObjectOfTexpense(DBManager dbManager,BankInterFace_DetailDto bankInterFace_DetailDto)throws Exception 
  {
    ...
    if(prpdBankCompannyDtoList.size() == 0){
    	 errorMessage="BLTransDataYB2700.generateObjectOfTexpense"+"prpdbankcompanny表"+strBankCode+"取值失败,请管理员进行配置！" ;
