...
public class BLCIAssemblePayNoQG{
    ...
    /**
     *得到一条CIAssemblePayNoQGSchema记录
     *@param index 下标
     *@return 一个CIAssemblePayNoQGSchema对象
     *@throws Exception
     */
