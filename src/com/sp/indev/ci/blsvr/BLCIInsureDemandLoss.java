...
/**
 * 定义XX查询违章表-CIInsureDemandLoss的BL类
...
public class BLCIInsureDemandLoss{
    ...
    /**
     *增加一条CIInsureDemandLossSchema记录
    ...
    /**
     *得到一条CIInsureDemandLossSchema记录
     *@param index 下标
     *@return 一个CIInsureDemandLossSchema对象
     *@throws Exception
     */
    ...
    /**
     *删除一条CIInsureDemandLossSchema记录
     *@param index 下标
     *@throws Exception
     */
