...
/**
 * 定义CICarShipTaxQGDemand-全国车船税基本类型XX查询表的数据传输对象类
 ...
 * @lastversion v1.2
 */
public class CICarShipTaxQGDemandSchema implements Serializable{
     ...
     * 构造函数
     */       
    public CICarShipTaxQGDemandSchema(){
    }
    ...
    public void setTaxStartDate(String TaxStartDate){
     if  (TaxStartDate == null||TaxStartDate.trim().equals("")) 
     {
        this.TaxStartDate = "";
     }
     else
    ...
    public void setTaxEndDate(String TaxEndDate){
     if  (TaxEndDate == null||TaxEndDate.trim().equals("") ) 
     {
        this.TaxEndDate = "";
     }
     else
    ...
    public void setTaxRateStartDate(String TaxRateStartDate){
     if  (TaxRateStartDate == null ||TaxRateStartDate.trim().equals("")) 
     {
    ...
    public void setTaxRateEndDate(String TaxRateEndDate){
     if  (TaxRateEndDate == null ||TaxRateEndDate.trim().equals("")) 
     {
        this.TaxRateEndDate = "";
     }
     else
    ...
    public void setExceedDate(String ExceedDate){
     if  (ExceedDate == null||ExceedDate.trim().equals("") ) 
     {
        this.ExceedDate = "";
     }
     else
    ...
    /**
     * @param iSchema 对象CICarShipTaxQGDemandSchema
     */       
    public void setSchema(CICarShipTaxQGDemandSchema iSchema)
    {
