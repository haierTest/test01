...
/**
 * 定义交管车辆信息查询-CIInsureDemandDriverSchema的数据传输对象类
 * add by fanjiangtao 
 * create date 2014-01-24
 */
public class CIInsureDemandDriverSchema implements Serializable{
     ...
     * 构造函数
     */       
    public CIInsureDemandDriverSchema(){
    }
	...
	/**
     * @param iSchema 对象CIInsureDemandDriverSchema
     */       
    public void setSchema(CIInsureDemandDriverSchema iSchema)
    {
