	...
	public void DataDealFirst(BLProposal blProposal,Map paramMap) throws Exception{
		...
		if("0507".equals(blProposal.getBLPrpTmain().getArr(0).getRiskCode())){
			...
			new DataDealForCal().generateTaxItem(blProposal);
		     ...
		     if("".equals((String) paramMap.get("RENEWALBIFLAG"))||((String) paramMap.get("RENEWALBIFLAG"))==null){
		    	 otherNature2BI = "0";
		     }else{
			 otherNature2BI = (String) paramMap.get("RENEWALBIFLAG");
		     }
		...
		}else if("0508".equals(blProposal.getBLPrpTmain().getArr(0).getRiskCode())){
	    ...
	    */
	    ...
	    if("0508".equals(blProposal.getBLPrpTmain().getArr(0).getRiskCode())){
		 ...
		 UseYears1 = PubTools.calculateCarYears(comCode,startDate,EnrollDate);
		  ...
		  if(clauseTypeBI.equals("F54") || clauseTypeBI.equals("F55")|| clauseTypeBI.equals("F56") || clauseTypeBI.equals("F57") || clauseTypeBI.equals("F61"))
		  {
...
* @date 2014-03-27
* */
	    public void processBLPrpTitemCar(BLProposal blProposal,BLPrpDcarModel blPrpDcarModel,Map paramMap)throws Exception {
	    	PrpTitemCarSchema prpTitemCarSchema = blProposal.getBLPrpTitemCar().getArr(0);
	    	String PurchasePrice = prpTitemCarSchema.getPurchasePrice();
